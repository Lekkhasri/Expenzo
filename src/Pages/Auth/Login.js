      ...
      <Container className="mt-5" style={{ position: "relative", zIndex: "2 !important" }}>
        <Row>
          <Col md={{ span: 6, offset: 3 }}>
            ...
            <p className="text-center text-warning">Come back again to Expenzo!</p>
            <Form>
              ...
              <Form.Group controlId="formBasicPassword" className="mt-3">
                ...
                <div className="position-relative">
                  <Form.Control type={showPassword ? "text" : "password"} name="password" placeholder="Password" onChange={handleChange} value={values.password} />
              ...
              <div className="mt-4 text-center">
                <Button type="submit" className="text-center mt-3 btnStyle" onClick={!loading ? handleSubmit : null} disabled={loading}>
                  {loading ? "Signin…" : "Login"}
                </Button>
                <p className="mt-3" style={{ color: "#9d9494" }}>
                  Don't Have an Account? <Link to="/register" className="text-white lnk">Register</Link>
                </p>
                <Link to="/forgotPassword" className="text-white lnk d-block mt-3">Forgot Password?</Link>
                <Button variant="light" className="mt-2 w-100">Continue with Google</Button>
                <Button variant="primary" className="mt-2 w-100">Continue with Microsoft</Button>
              </div>
            </Form>
          </Col>
        </Row>
